<x-layouts.app-layout>
    ...
    <x-slot name="page">
        <main id="main">
            ...
            @include('pages.Home.components.featured-section')
           <!-- End Featured Services Section -->
        
            <!-- ======= About Section ======= -->
            @include('pages.Home.components.about-us')
           <!-- End About Section -->
        
            <!-- ======= Clients Section ======= -->
            @include('pages.Home.components.clients')
            <!-- End Clients Section -->
            ...
            <!-- ======= On Focus Section ======= -->
            @include('pages.Home.components.onfocus')
           ...
           <!-- End Pricing Section -->
            ...
            <!-- ======= F.A.Q Section ======= -->
            @include('pages.Home.components.faq')
           <!-- End F.A.Q Section -->
            ...
            <!-- ======= Team Section ======= -->
            @include('pages.Home.components.team')
           <!-- End Team Section -->
        
            <!-- ======= Recent Blog Posts Section ======= -->
            @include('pages.Home.components.recent-blog-posts')
           <!-- End Recent Blog Posts Section -->
        
            <!-- ======= Contact Section ======= -->
            @include('pages.Home.components.contact')
           <!-- End Contact Section -->
